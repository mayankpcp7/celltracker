...
const HowItWorks = () => {
  return (
    <>
      <div className="max-w-[1188px] mx-auto px-6 py-[68px] sm:py-14 md:py-20 lg:pt-[104px] relative ">
        <img
        ...
        <div className="flex flex-row gap-8 lg:gap-0 items-center justify-center flex-wrap mt-8">
          <div className="lg:w-6/12 w-full sm:w-11/12">
            <img
              className="max-w-[441px] sm:max-w-[580px] -ms-12 xs:mx-auto xl:max-w-[729px]  lg:-translate-x-6 xl:-translate-x-20"
              src={mobiles}
              alt="mobiles"
            />
          </div>
          <div className="w-full lg:w-6/12 sm:w-9/12 lg:ps-6 lg:pt-12">
            <div className="flex flex-col items-center gap-[18px]">
              <div className="flex flex-col min-h-[303px] xs:min-h-[273px] max-w-[536px] rounded-xl shadow-join-card border bg-white px-5 pt-5 pb-3 border-borderGrey">
                <WorkLocation />
                <h3 className="pt-2 sm:pt-4 text-darkBlue text-xl sm:text-2xl font-mukta font-normal">
                  Locate the people important to you, from any web device
                </h3>
                <p className="text-sm sm:text-base min-w-[289px] text-lightBlack font-mukta font-normal leading-md">
              ...
              <div className="flex flex-col min-h-[303px] xs:min-h-[273px] max-w-[536px] rounded-xl shadow-join-card border bg-white px-5 pt-5 pb-3 border-borderGrey">
                ...
                <p className="text-sm sm:text-base max-w-[275px] xs:max-w-full text-lightBlack font-mukta font-normal leading-md">
