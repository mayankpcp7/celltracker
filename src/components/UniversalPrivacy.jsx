...
const UniversalPrivacy = () => {
  return (
    <div className="mt-[52px] xl:mt-[76px] md:mt-[10px] ">
      
    <div className="max-w-[1164px] mx-auto px-6 sm:px-3 relative">
    <img
        className="max-w-[41px] sm:max-w-[106px]  md:hidden bottom-[-11%] rotate-[180deg] left-0 xl:left-[-11.8%]  absolute "
        src={Rightvector}
        alt="vector"
      />
    <img
        className="max-w-[41px] sm:max-w-[106px] top-[-5%] md:top-[16%] right-0 xl:right-[-11.8%]  absolute "
        src={Rightvector}
        alt="vector"
      />
