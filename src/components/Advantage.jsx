...
const Advantage = () => {
  return (
    <>
      ...
      />
      <img
        className="w-full relative z-[60] hidden xs:block min-h-[97px] -mt-[15%] sm:-my-[12.5%]"
        src={layer}
        alt="layer"
      />
      <div className="max-w-[1188px] mt-10 z-[70] px-6 mx-auto relative">
        ...
        />
        <img
          className="absolute z-0 end-0 sm:end-[-10%] animate-pulse pointer-events-none max-w-[41px] sm:max-w-[106px] -bottom-[3%] sm:bottom-[-10%]"
          src={leftvector}
          alt="vector"
        />
