...
const FindAnyone = () => {
  return (
    <div className="mt-[97px] xl:mt-[132px] relative">
      <img
        className="max-w-[41px] sm:max-w-[106px] hidden md:block top-[2%] rotate-[180deg] left-0   absolute "
        src={Rightvector}
        alt="vector"
      />
      <img
        className="max-w-[41px] sm:max-w-[106px] top-[33%] md:bottom-[-4%] right-0   absolute "
        src={Rightvector}
        alt="vector"
      />
      <div className="max-w-[1164px] mx-auto px-6 sm:px-3 ">
        <div className="px-3">
          <BlueHeading
            headingText="Find Anyone Anywhere"
            boldText=" for Under $1"
          />
        </div>
        <div className="px-6">
        ...
        <div className="flex flex-wrap items-center justify-center mt-[31px] sm:mt-14">
          <div className="w-full sm:w-1/2 order-1 mt-[47px] sm:mt-0 sm:order-0  justify-center flex flex-col items-center lg:w-1/3">
            <div className="max-w-[376px] bg-white z-10 gradient-card group hover:bg-linear-blue h-[152px] md:h-[156px] mb-[18px] sm:mb-6 border-[1px] flex items-center border-offGrey rounded-[4px] py-10 md:py-[42.5px] pe-[18px]">
              ...
              <h4 className="font-normal text-lg md:text-xl font-mukta ps-[14px] transition-all duration-200 ease-in-out group-hover:text-white">
            ...
            <div className="max-w-[376px] bg-white z-10 gradient-card group hover:bg-linear-blue h-[152px] md:h-[156px] mb-[18px] sm:mb-6 lg:mb-0 border-[1px] flex items-center border-offGrey rounded-[4px] py-10 md:py-[42.5px] sm:pe-[18px]">
              ...
              <h4 className="font-normal text-lg md:text-xl font-mukta ps-[8px] transition-all duration-200 ease-in-out group-hover:text-white">
                Customize the message you want the recipient to recieve. Or use
          ...
          <div className="w-full sm:w-1/2 order-0 sm:order-1 lg:w-1/3">
            <div className="flex justify-center ml-5">
              <img
                src={IphoneMockup}
                alt="loction mobile"
                className="w-[213px] h-[319px] sm:w-[256px] sm:h-[386px]"
              />
            </div>
          </div>
