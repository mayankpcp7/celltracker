  ...
  return (
    <div className="bg-landing-sm-hero sm:bg-landing-hero relative z-[1] flex flex-col bg-no-repeat bg-cover bg-center lg:bg-full min-h-[812px] sm:min-h-[800px]">
      ...
      <nav>
        <div className="max-w-[1164px] px-6 sm:px-3 mx-auto sm:mt-[7px]">
          <div className="flex justify-between pt-[32px] pb-[10px] sm:h-[100px] items-center">
            ...
            <ul
              className={`flex items-center gap-[20px] sm:gap-[35px] duration-300 max-md:fixed max-md:w-full max-md:h-full max-md:justify-start max-md:pt-[121px] max-md:flex-col max-md:z-[3] max-md:top-0 max-md:left-[-105%] max-md:p-[30px] max-md:bg-white ${navBar && "!left-0"
                }`}
            >
              <li>
                <a
      ...
      <div className=" h-full mt-[56px] lg:mt-[83px]">
              ...
              <div className=" max-lg:mx-auto bg-white rounded flex items-center justify-between ps-2.5 max-w-[448px] mt-6">
                <div className=" flex items-center gap-[7px] ">
                  ...
                  <select
                    ...
                    id="number"
                  >
                    <option value="91" className="flex font-mukta items-center gap-2 ">
                      +91
                    </option>
                    <option value="01" className="flex font-mukta items-center gap-2 ">
                      +01
                    </option>
                    <option value="92" className="flex font-mukta items-center gap-2 ">
                      +92
                    </option>
                    <option value="02" className="flex font-mukta items-center gap-2 ">
                      +02
                    </option>
                    <option value="21" className="flex font-mukta items-center gap-2 ">
                      +21
                    </option>
                  </select>
                </div>
        ...
        alt="vector"
      />
                      <p className="text-sm text-black font-mukta absolute right-4  font-light">June 02,2024   17:34</p>
                    </div>
                  </div>
                </div>
              </div>
